...
function SOPProvider({ children }) {
    const [sops, setSops] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mockSOPs"]);
    ...
    const addNote = (sopId, note)=>{
        updateSOP(sopId, {
            notes: [
                ...sops.find((s)=>s.id === sopId)?.notes || [],
                note
            ]
        });
    };
    const updateNote = (sopId, noteId, updates)=>{
    ...
    const addMessage = (sopId, message)=>{
        const sop = sops.find((s)=>s.id === sopId);
        if (sop) {
            updateSOP(sopId, {
                chatHistory: [
    ...
    const updateSessionNote = (noteId, updates)=>{
        setSession((prev)=>prev ? {
                ...prev,
    ...
    const deleteSessionNote = (noteId)=>{
        setSession((prev)=>prev ? {
                ...prev,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e41514f._.js.map