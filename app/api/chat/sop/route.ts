...
import { streamObjectWithFallback } from '@/lib/ai-fallback';
...
// -----------------------------------------------------------------------------
// POST Handler
// Calls the centralized fallback utility for streaming object generation.
// -----------------------------------------------------------------------------
...
export async function POST(req: Request) {
  try {
    ...
    return await streamObjectWithFallback({
      system: systemPrompt,
      prompt,
